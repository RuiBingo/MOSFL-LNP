function prediction_score=NTSHMDA(interaction,gamma,phi,delte,beta1,beta2)
...
% kd = Label_Propagation(interaction,0,32,'regulation2');
% km = Label_Propagation(interaction',0,5,'regulation2');
